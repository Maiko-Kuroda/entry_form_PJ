    ...
    <div class="container">
        <div class="col-md-10 mx-auto">
            ...
            <div class="questionary-form-group ml-5 mb-3">
                ...
                3 大会参加に先駆けた体調管理表の送付<br>
                4 大会の協賛会社からのサービス案内<br>
                5 大会のアンケート<br>
                6 記録の集計・発表<br>
                ・新チャレンジマラソンは、個人情報を第三者との間で共同利用し、または、個人情報の取得の扱いを第三者に委託する場合は、 当該第三者につき厳正な調査を行ったうえ、秘密を保持させるために、適正な監督を行います。<br>
                </div>
            </div>
            <div class="questionary-form-group-title mb-3">
                ...
                <div class="questionary-form-group ml-5 mb-3">
                    <div class="row">
                    新チャレンジマラソンは、法令に定める場合を除き、個人情報を、事前に本人の同意を得ることなく、第三者に提供しません。
                    </div>
                </div>
                <div class="questionary-form-group-title mb-3">
                ...
                <div class="questionary-form-group ml-5 mb-3">
                    <div class="row">
                    ・新チャレンジマラソンは個人情報の正確性を保ち、これを安全に管理致します。<br>
                    ・新チャレンジマラソンは、個人情報の紛失、破壊、改ざん及び漏えいなどを防止するため、不正アクセス、 コンピューターウイルス等に対する適正なセキュリティ対策を講じます。<br>
                    </div>
                </div>
                <div class="questionary-form-group-title mb-3">
