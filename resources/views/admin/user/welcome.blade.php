                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mt-5">
                            ...
                            <h5>
                                <p>「新チャレンジマラソン」には、以下の注意事項をご理解の上、大会当日までに体調管理表へのチェックおよび前日・当日朝２回の検温を済ませ、ご参加ください。<br><br>体調管理表へのチェックおよび前日・当日朝２回の検温はWEB画面上から登録をお願いいたします。（「体調管理表」「検温入力」ボタンよりご登録ください）<br><br>登録内容が参加基準を満たしている場合は、「参加OK」の画面が表示されますので、当日受付にて「参加OK」画面をご提示ください。</p>
                            </h5>
                        </div>
                    </div>
                </div>
